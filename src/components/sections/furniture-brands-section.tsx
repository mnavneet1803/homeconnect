      ...
      <Container>
        <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-16">
          <Reveal variant="fade-up" className="spotlight-copy">
            <p className="section-eyebrow text-rust-600 before:bg-rust-600">Furniture & shed assembly</p>
            <h2 className="mt-3.5 text-balance text-display-sm text-pine-950 md:text-[clamp(26px,3.2vw,36px)]">
              We assemble furniture and outdoor sheds from every major retailer
            </h2>
            <p className="mt-3.5 max-w-[460px] text-ink-600">
              Wardrobes, beds, office desks, flat-pack kits, and backyard shed / storage builds —
              unboxed, built square, and anchored where it matters. No leftover screws, no wobble.
            </p>
